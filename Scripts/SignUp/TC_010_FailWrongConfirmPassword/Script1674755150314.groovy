...
WebUI.setEncryptedText(findTestObject('SignUp/Component/txtPassword'), '8SQVv/p9jVTHLrggi8kCzw==')

WebUI.setEncryptedText(findTestObject('SignUp/Component/txtConfirmPassword'), 'YBDo7bJRof0=')
