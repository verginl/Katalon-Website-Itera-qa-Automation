...
WebUI.click(findTestObject('Dashboard/Table Data/a_Details'))

WebUI.verifyElementText(findTestObject('Dashboard/PageDetail/dd_Vergi Nardian Lufyandi'), 'Vergi Nardian Lufyandi')
