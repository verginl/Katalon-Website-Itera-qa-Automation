...
WebUI.setText(findTestObject('Dashboard/input_Create New_searching'), 'asdasdasdasdddddddd')

WebUI.waitForPageLoad(5)

WebUI.click(findTestObject('Dashboard/btnSearch'))

WebUI.verifyElementText(findTestObject('Dashboard/Table Data/td_No Match'), 'No Match')
