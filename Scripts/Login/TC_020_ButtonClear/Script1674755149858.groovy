...
WebUI.click(findTestObject('PageLogin/btnClear'))

WebUI.verifyElementText(findTestObject('PageLogin/txtUsername'), '')

WebUI.verifyElementText(findTestObject('PageLogin/txtPassword'), '')
